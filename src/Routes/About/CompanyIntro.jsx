  ...
  return (
    <div className="professional-intro-container">
      ...
      <div className="professional-intro-section">
        ...
        <p id='heroP'>
          شركة رائدة في مجال المقاولات و التوريدات العامة و التشطيبات و العاقارات.
          نضم تحت مظلتنا كل القطاعات الرئيسية الخاصة بالتوريدات الكهرباءية و التكييف و السباكة و الصيانة و التشغيل و ادارة الأملاك تحت مظلة كيان واحد (القمة اللامعة).
        </p>
      </div>
      {/* Section 1 */}
      <div className="professional-intro-section">
        <div className="professional-intro-text">
          ...
          <ul>
              <li>
                نعمل على تلبية تطلعات العملاء و شركاء نجاحنا من خلال استشارات بغض النظر عن اتمام عمليات الشراء من غيرها.
              </li>
              <li>
      ...
      <div className="professional-intro-section reverse">
        ...
        <div className="professional-intro-text">
          <h2>قيمنا</h2>
          <p>
              تقدم الشركة كل خدماتها و منتجاتها بمنهجية تضمن تحقيق <strong>الأمانة</strong> و <strong>الكفاءة</strong> و <strong>الثقة</strong> و <strong>الملائمة</strong> و <strong>الاستدامة</strong>.
          </p>
        </div>
      </div>
      ...
      <div className="professional-intro-section">
        ...
        <ol>
            ...
            <li>
                <p><GrVmMaintenance /> <strong>الصيانة و التشغيل و ادارة الأملاك</strong>.</p>
            </li> <br />
            <li>
