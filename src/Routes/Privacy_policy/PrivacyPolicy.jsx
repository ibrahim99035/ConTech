...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-policy-container">
      ...
      <header>
        <h1 className="privacy-policy-title">سياسة الخصوصية لشركة القمة اللامعة</h1>
      </header>

      <section>
        <p className="privacy-policy-text">
          نرحب بكم في شركة القمة اللامعة ، حيث نهتم بحماية خصوصيتكم ونسعى لتوفير تجربة آمنة أثناء تفاعلكم مع خدماتنا. تهدف هذه الوثيقة إلى توضيح كيفية جمعنا واستخدامنا للمعلومات الشخصية وكيف نحمي هذه المعلومات.
        </p>
      </section>
      ...
      <section>
        ...
        <p>نشكركم على ثقتكم في شركة القمة اللامعة. نحن نعمل جاهدين لتقديم خدمات عالية الجودة مع احترام تام لخصوصيتكم وحقوقكم.</p>
      </section>
      <div id='plogoDiv'>
